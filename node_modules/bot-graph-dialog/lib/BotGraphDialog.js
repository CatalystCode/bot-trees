...
function BotGraphDialog(opts) {
    ...
    // Creating bots dictionary
    this.bots = {};
    (opts.tree.bots || []).forEach(function (bot) { self.bots[bot.name] = bot; });
...
BotGraphDialog.prototype.getSteps = function() {
  ...
  function performAcion(session, next) {
    ...
    switch (currentNode.type) {
      ...
      case 'score':
        var botModels = currentNode.data.bots.map(function (bot) {
          return self.bots[bot];
        });
        var text = session.dialogData[currentNode.data.source];
